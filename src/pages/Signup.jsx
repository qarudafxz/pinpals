		...
		<div>
			...
			<div className='mx-8 md:m-0'>
				<div className='m-auto bg-secondary border-2 border-[#686868] rounded-md py-6 px-4 mt-20 xsm:w-full md:w-7/12 lg:w-5/12 xl:w-3/12 px-8'>
					...
					{hasGoogleAccount && (
						<h1 className='my-4 font-body text-sm text-red-600 mt-2'>
					...
					<form
						...
						<div className='grid grid-cols-1 place-items-center relative'>
							...
							<IoEyeSharp
								className={`absolute top-1/2 transform -translate-y-1/2 right-4 cursor-pointer ${
									isVisible ? "text-blue" : "text-[#b8b8b8]"
								}`}
						...
						{isInvalid && (
							<p className='text-red-500 text-sm font-body font-semibold'>
						...
						<button className='bg-blue py-2 px-4 rounded-md cursor-pointer font-body font-semibold text-white mt-10 xl:mb-8'>
							Sign Up
						</button>
						{!isLoaded && (
							<div className='grid place-items-center'>
								<Loading className='pt-12' />
								<h1 className='text-white font-logo text-xl mb-10'>
									Creating account...
								</h1>
							</div>
						)}
				...
				<img
					src={Bg}
					className='absolute w-2/4 xxxsm:top-32 -z-10 xxsm:top-20 xsm:top-0 w-11/12 xl:w-full h-auto'
				/>
			</div>
			<Footer />
		</div>
